...
use swc_common::{
    comments::SingleThreadedComments, sync::Lrc, FileName, SourceMap, Spanned, DUMMY_SP,
};
use swc_ecma_ast::{
...
use binding::{
    ...
    resolve_function_binding_name, resolve_function_binding_names, simple_assign_target_ident,
    TopLevelBinding,
};
