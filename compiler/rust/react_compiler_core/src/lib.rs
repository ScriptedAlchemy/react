...
use runtime_binding_utils::{
    ...
    extract_runtime_callee_from_object_pat, is_require_runtime_call,
    member_expr_is_runtime_namespace_c,
};
use runtime_helpers::{
...
use runtime_scope::{
    ...
    collect_declared_binding_names_from_stmt, collect_declared_binding_names_from_stmts,
    for_head_declared_binding_names, for_init_declared_binding_names,
