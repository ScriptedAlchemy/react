...
use helpers::span_to_location;
use parse::parse_syntax_error_reason;
use placeholder::count_runtime_helper_imports;
use placeholder_apply::{
    apply_placeholder_compilation_to_module, apply_placeholder_compilation_to_script,
};
use react_detect::{
