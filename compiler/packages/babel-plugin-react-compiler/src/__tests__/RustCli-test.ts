...
describeWithCargo('Rust compiler CLI bridge', () => {
  ...
  it('resolves fixture entrypoint escaped string object keys', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('resolves fixture entrypoint escaped template-literal object keys', () => {
    const result = runRustCompilerCli({
      source:
        'function component() { return 1; } export const FIXTURE_ENTRYPOINT = { [`\\x66n`]: component, params: [] };',
      dialect: 'javascript',
  ...
  it('resolves fixture entrypoint unicode escaped template-literal object keys', () => {
    const result = runRustCompilerCli({
      source:
        'function component() { return 1; } export const FIXTURE_ENTRYPOINT = { [`\\u0066n`]: component, params: [] };',
      dialect: 'javascript',
  ...
  it('resolves fixture entrypoint escaped string member assignments', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('resolves fixture entrypoint template-literal member assignments', () => {
    const result = runRustCompilerCli({
      source:
        'function component() { return 1; } const FIXTURE_ENTRYPOINT = { params: [] }; FIXTURE_ENTRYPOINT[`fn`] = component;',
      dialect: 'javascript',
  ...
  it('resolves fixture entrypoint escaped template-literal member assignments', () => {
    const result = runRustCompilerCli({
      source:
        'function component() { return 1; } const FIXTURE_ENTRYPOINT = { params: [] }; FIXTURE_ENTRYPOINT[`\\x66n`] = component;',
      dialect: 'javascript',
  ...
  it('resolves fixture entrypoint unicode escaped template-literal member assignments', () => {
    const result = runRustCompilerCli({
      source:
        'function component() { return 1; } const FIXTURE_ENTRYPOINT = { params: [] }; FIXTURE_ENTRYPOINT[`\\u0066n`] = component;',
      dialect: 'javascript',
  ...
  it('resolves script fixture entrypoint unicode escaped template-literal object keys', () => {
    const result = runRustCompilerCli({
      source:
        'function render() { return 1; } const FIXTURE_ENTRYPOINT = { [`\\u0066n`]: render, params: [] };',
      dialect: 'javascript',
  ...
  it('resolves script fixture entrypoint escaped string object keys', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('resolves script fixture entrypoint unicode escaped template-literal member assignments', () => {
    const result = runRustCompilerCli({
      source:
        'function render() { return 1; } const FIXTURE_ENTRYPOINT = { params: [] }; FIXTURE_ENTRYPOINT[`\\u0066n`] = render;',
      dialect: 'javascript',
  ...
  it('resolves script fixture entrypoint escaped string member assignments', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('reuses module runtime require escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('reuses module runtime require unicode escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const cache = require('react/compiler-\\u0072untime').c; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        'const cache = require(`react/compiler-\\x72untime`).c; export function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('reuses module runtime require unicode escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        'const cache = require(`react/compiler-\\u0072untime`).c; export function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('reuses module runtime require escaped string namespace aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('reuses module runtime require unicode escaped string namespace aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime.c; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require escaped template-literal namespace aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        'const runtime = require(`react/compiler-\\x72untime`); const cache = runtime.c; export function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('reuses module runtime require unicode escaped template-literal namespace aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        'const runtime = require(`react/compiler-\\u0072untime`); const cache = runtime.c; export function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('reuses module runtime require namespace escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('reuses module runtime require escaped template-literal namespace escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require(`react/compiler-\\x72untime`); const cache = runtime['\\x63']; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require unicode escaped template-literal namespace escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require(`react/compiler-\\u0072untime`); const cache = runtime['\\x63']; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require escaped string namespace unicode escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\x72untime'); const cache = runtime['\\u0063']; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require unicode escaped string namespace unicode escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime['\\u0063']; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require escaped string namespace escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\x72untime'); const cache = runtime[`\\x63`]; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require unicode escaped string namespace escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime[`\\x63`]; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require escaped string namespace unicode escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\x72untime'); const cache = runtime[`\\u0063`]; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require unicode escaped string namespace unicode escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime[`\\u0063`]; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require namespace unicode escaped string member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-runtime'); const cache = runtime['\\u0063']; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require namespace escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-runtime'); const cache = runtime[`\\x63`]; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('reuses module runtime require namespace unicode escaped template-literal member aliases for placeholder transforms', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-runtime'); const cache = runtime[`\\u0063`]; export function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('transforms script components with runtime require unicode escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('transforms script components with runtime require escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        'const cache = require(`react/compiler-\\x72untime`).c; function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require unicode escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        'const cache = require(`react/compiler-\\u0072untime`).c; function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require escaped string namespace aliases', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('transforms script components with runtime require unicode escaped string namespace aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime.c; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require escaped template-literal namespace aliases', () => {
    const result = runRustCompilerCli({
      source:
        'const runtime = require(`react/compiler-\\x72untime`); const cache = runtime.c; function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require unicode escaped template-literal namespace aliases', () => {
    const result = runRustCompilerCli({
      source:
        'const runtime = require(`react/compiler-\\u0072untime`); const cache = runtime.c; function Component() { return <div />; }',
      dialect: 'javascript',
  ...
  it('transforms script components with runtime namespace escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
  ...
  it('transforms script components with runtime require escaped template-literal namespace escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require(`react/compiler-\\x72untime`); const cache = runtime['\\x63']; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require unicode escaped template-literal namespace escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require(`react/compiler-\\u0072untime`); const cache = runtime['\\x63']; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require escaped string namespace unicode escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\x72untime'); const cache = runtime['\\u0063']; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require unicode escaped string namespace unicode escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime['\\u0063']; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require escaped string namespace escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\x72untime'); const cache = runtime[`\\x63`]; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require unicode escaped string namespace escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime[`\\x63`]; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require escaped string namespace unicode escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\x72untime'); const cache = runtime[`\\u0063`]; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime require unicode escaped string namespace unicode escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-\\u0072untime'); const cache = runtime[`\\u0063`]; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime namespace unicode escaped string member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-runtime'); const cache = runtime['\\u0063']; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime namespace escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-runtime'); const cache = runtime[`\\x63`]; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('transforms script components with runtime namespace unicode escaped template-literal member aliases', () => {
    const result = runRustCompilerCli({
      source:
        "const runtime = require('react/compiler-runtime'); const cache = runtime[`\\u0063`]; function Component() { return <div />; }",
      dialect: 'javascript',
  ...
  it('throws when rust cli returns non-integer error locations', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
  ...
  it('throws when rust cli returns inconsistent ok count fields', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        detected_component_function_count: 1,
        detected_hook_function_count: 0,
        detected_component_functions: ["Component"],
        ...
        placeholder_transform_candidate_count: 1,
        ...
        placeholder_runtime_namespace_candidate_count: 0,
        react_functions: [{name: "Component", kind: "Component", loc: null}]
      }));`,
      scriptPath => {
        withEnvVar('REACT_COMPILER_RUST_CLI_BIN', scriptPath, () => {
          expect(() =>
  ...
  it('throws when rust cli returns inconsistent ok kind count fields', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        detected_hook_functions: [],
        placeholder_transforms_applied: 0,
        placeholder_transform_candidates: ["Component"],
        placeholder_transform_skipped_functions: ["Component"],
        placeholder_transform_candidate_count: 1,
        placeholder_transform_skipped_count: 1,
        placeholder_transform_candidate_component_count: 1,
        placeholder_transform_candidate_hook_count: 1,
        placeholder_transform_transformed_component_count: 0,
        placeholder_transform_transformed_hook_count: 0,
        placeholder_transform_skipped_component_count: 1,
        placeholder_transform_skipped_hook_count: 0,
  ...
  it('throws when rust cli returns unknown ok transform status', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        placeholder_runtime_callee_reused: false,
        placeholder_runtime_callee_generated: false,
        placeholder_transform_status: "unknown_status",
        detected_react_functions: 1,
        detected_component_function_count: 1,
        detected_hook_function_count: 0,
        detected_component_functions: ["Component"],
  ...
  it('throws when rust cli returns transformed functions outside candidate set', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        placeholder_runtime_callee_reused: false,
        placeholder_runtime_callee_generated: false,
        placeholder_transform_status: "transformed",
        detected_react_functions: 1,
        detected_component_function_count: 1,
        detected_hook_function_count: 0,
        detected_component_functions: ["Component"],
        detected_hook_functions: [],
        placeholder_transforms_applied: 1,
        placeholder_transform_candidates: ["Component"],
        placeholder_transform_skipped_functions: [],
        placeholder_transform_candidate_count: 1,
        placeholder_transform_skipped_count: 0,
        ...
        placeholder_transform_skipped_component_count: 0,
        placeholder_transform_skipped_hook_count: 0,
        placeholder_transformed_functions: ["OtherComponent"],
        placeholder_runtime_callee_candidates_before_transform: [],
        placeholder_runtime_callee_candidate_count_before_transform: 0,
        placeholder_runtime_namespace_candidates_before_transform: [],
        placeholder_runtime_namespace_candidate_count_before_transform: 0,
  ...
  it('throws when rust cli returns duplicated transform candidate names', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        detected_hook_functions: [],
        placeholder_transforms_applied: 1,
        placeholder_transform_candidates: ["Component", "Component"],
        placeholder_transform_skipped_functions: ["Component"],
        placeholder_transform_candidate_count: 2,
        placeholder_transform_skipped_count: 1,
        placeholder_transform_candidate_component_count: 2,
        placeholder_transform_candidate_hook_count: 0,
        placeholder_transform_transformed_component_count: 1,
        placeholder_transform_transformed_hook_count: 0,
        placeholder_transform_skipped_component_count: 1,
        placeholder_transform_skipped_hook_count: 0,
        placeholder_transformed_functions: ["Component"],
        placeholder_runtime_callee_candidates_before_transform: [],
        placeholder_runtime_callee_candidate_count_before_transform: 0,
        placeholder_runtime_namespace_candidates_before_transform: [],
        placeholder_runtime_namespace_candidate_count_before_transform: 0,
  ...
  it('throws when rust cli returns detected names with mismatched kinds', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        detected_component_function_count: 1,
        detected_hook_function_count: 0,
        detected_component_functions: ["useThing"],
        detected_hook_functions: [],
        placeholder_transforms_applied: 0,
        placeholder_transform_candidates: [],
        placeholder_transform_skipped_functions: [],
        ...
        placeholder_runtime_namespace_candidates: [],
        placeholder_runtime_namespace_candidate_count: 0,
        react_functions: [{name: "useThing", kind: "Hook", loc: null}]
      }));`,
      scriptPath => {
        withEnvVar('REACT_COMPILER_RUST_CLI_BIN', scriptPath, () => {
          expect(() =>
  ...
  it('throws when rust cli returns duplicated detected function names', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        placeholder_runtime_callee_generated: false,
        placeholder_transform_status: "no_candidates",
        detected_react_functions: 2,
        detected_component_function_count: 2,
        detected_hook_function_count: 0,
        detected_component_functions: ["Component", "Component"],
        detected_hook_functions: [],
        placeholder_transforms_applied: 0,
        placeholder_transform_candidates: [],
        placeholder_transform_skipped_functions: [],
        ...
        placeholder_runtime_namespace_candidate_count: 0,
        react_functions: [
          {name: "Component", kind: "Component", loc: null},
          {name: "Component", kind: "Component", loc: null}
        ]
      }));`,
      scriptPath => {
  ...
  it('throws when rust cli returns non-integer react function locations', () => {
    if (process.platform === 'win32') {
      return;
    }
    withTempRustCliScript(
      `process.stdout.write(JSON.stringify({
        ...
        react_functions: [{
          name: "Component",
          kind: "Component",
          loc: {start_line: 1, start_column: 0, end_line: 2.5, end_column: 1}
        }]
      }));`,
      scriptPath => {
        withEnvVar('REACT_COMPILER_RUST_CLI_BIN', scriptPath, () => {
