...
- Runtime helper alias detection recognizes:
  ...
  - signed decimals with post-sign vertical-tab+form-feed+tab+line-feed+carriage-return whitespace also fold as non-equal
    (e.g. `(16n == '+\v\f\t\n\r16')` folds as false)
  - signed decimals with post-sign vertical-tab+line-feed+form-feed+carriage-return+tab whitespace also fold as non-equal
    (e.g. `(16n == '+\v\n\f\r\t16')` folds as false)
  - signed decimals with post-sign vertical-tab+line-feed+form-feed+tab+carriage-return whitespace also fold as non-equal
    (e.g. `(16n == '+\v\n\f\t\r16')` folds as false)
  - signed decimals with post-sign vertical-tab+line-feed+carriage-return+form-feed+tab whitespace also fold as non-equal
    (e.g. `(16n == '+\v\n\r\f\t16')` folds as false)
  - signed decimals with post-sign vertical-tab+line-feed+carriage-return+tab+form-feed whitespace also fold as non-equal
    (e.g. `(16n == '+\v\n\r\t\f16')` folds as false)
  - signed decimals with post-sign vertical-tab+line-feed+tab+form-feed+carriage-return whitespace also fold as non-equal
    (e.g. `(16n == '+\v\n\t\f\r16')` folds as false)
  - signed decimals with post-sign vertical-tab+line-feed+tab+carriage-return+form-feed whitespace also fold as non-equal
    (e.g. `(16n == '+\v\n\t\r\f16')` folds as false)
  - signed decimals with post-sign line-feed+vertical-tab+form-feed+carriage-return+tab whitespace also fold as non-equal
    (e.g. `(16n == '+\n\v\f\r\t16')` folds as false)
  - signed decimals with post-sign line-feed+vertical-tab+form-feed+tab+carriage-return whitespace also fold as non-equal
    (e.g. `(16n == '+\n\v\f\t\r16')` folds as false)
  - signed decimals with post-sign line-feed+vertical-tab+carriage-return+form-feed+tab whitespace also fold as non-equal
    (e.g. `(16n == '+\n\v\r\f\t16')` folds as false)
  - signed decimals with post-sign line-feed+vertical-tab+carriage-return+tab+form-feed whitespace also fold as non-equal
    (e.g. `(16n == '+\n\v\r\t\f16')` folds as false)
  - signed decimals with post-sign line-feed+vertical-tab+tab+form-feed+carriage-return whitespace also fold as non-equal
    (e.g. `(16n == '+\n\v\t\f\r16')` folds as false)
  - signed decimals with post-sign line-feed+vertical-tab+tab+carriage-return+form-feed whitespace also fold as non-equal
    (e.g. `(16n == '+\n\v\t\r\f16')` folds as false)
  - signed decimals with post-sign line-feed+form-feed+carriage-return+tab+vertical-tab whitespace also fold as non-equal
    (e.g. `(16n == '+\n\f\r\t\v16')` folds as false)
  - signed decimals with post-sign line-feed+form-feed+carriage-return+vertical-tab+tab whitespace also fold as non-equal
    (e.g. `(16n == '+\n\f\r\v\t16')` folds as false)
  - signed decimals with post-sign line-feed+form-feed+tab+carriage-return+vertical-tab whitespace also fold as non-equal
    (e.g. `(16n == '+\n\f\t\r\v16')` folds as false)
  - signed decimals with post-sign line-feed+form-feed+tab+vertical-tab+carriage-return whitespace also fold as non-equal
    (e.g. `(16n == '+\n\f\t\v\r16')` folds as false)
  - signed decimals with post-sign line-feed+form-feed+vertical-tab+carriage-return+tab whitespace also fold as non-equal
    (e.g. `(16n == '+\n\f\v\r\t16')` folds as false)
  - signed decimals with post-sign line-feed+form-feed+vertical-tab+tab+carriage-return whitespace also fold as non-equal
    (e.g. `(16n == '+\n\f\v\t\r16')` folds as false)
  - signed decimals with post-sign line-feed+tab+carriage-return+form-feed+vertical-tab whitespace also fold as non-equal
    (e.g. `(16n == '+\n\t\r\f\v16')` folds as false)
  ...
  - signed decimals with post-sign tab+form-feed+carriage-return+vertical-tab whitespace also fold as non-equal
    (e.g. `(16n == '+\t\f\r\v16')` folds as false)
  ...
  - signed-decimal template strings with post-sign vertical-tab+form-feed+tab+line-feed+carriage-return whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\v\f\t\n\r16'}`)`` folds as false)
  - signed-decimal template strings with post-sign vertical-tab+line-feed+form-feed+carriage-return+tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\v\n\f\r\t16'}`)`` folds as false)
  - signed-decimal template strings with post-sign vertical-tab+line-feed+form-feed+tab+carriage-return whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\v\n\f\t\r16'}`)`` folds as false)
  - signed-decimal template strings with post-sign vertical-tab+line-feed+carriage-return+form-feed+tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\v\n\r\f\t16'}`)`` folds as false)
  - signed-decimal template strings with post-sign vertical-tab+line-feed+carriage-return+tab+form-feed whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\v\n\r\t\f16'}`)`` folds as false)
  - signed-decimal template strings with post-sign vertical-tab+line-feed+tab+form-feed+carriage-return whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\v\n\t\f\r16'}`)`` folds as false)
  - signed-decimal template strings with post-sign vertical-tab+line-feed+tab+carriage-return+form-feed whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\v\n\t\r\f16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+vertical-tab+form-feed+carriage-return+tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\v\f\r\t16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+vertical-tab+form-feed+tab+carriage-return whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\v\f\t\r16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+vertical-tab+carriage-return+form-feed+tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\v\r\f\t16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+vertical-tab+carriage-return+tab+form-feed whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\v\r\t\f16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+vertical-tab+tab+form-feed+carriage-return whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\v\t\f\r16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+vertical-tab+tab+carriage-return+form-feed whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\v\t\r\f16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+form-feed+carriage-return+tab+vertical-tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\f\r\t\v16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+form-feed+carriage-return+vertical-tab+tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\f\r\v\t16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+form-feed+tab+carriage-return+vertical-tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\f\t\r\v16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+form-feed+tab+vertical-tab+carriage-return whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\f\t\v\r16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+form-feed+vertical-tab+carriage-return+tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\f\v\r\t16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+form-feed+vertical-tab+tab+carriage-return whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\f\v\t\r16'}`)`` folds as false)
  - signed-decimal template strings with post-sign line-feed+tab+carriage-return+form-feed+vertical-tab whitespace also fold as non-equal
    (e.g. ``(16n == `${'+\n\t\r\f\v16'}`)`` folds as false)
  ...
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\t\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\t\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\t\n\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+line-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\n\t\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+line-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\n\r\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\t\r\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+carriage-return+tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\r\t\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+vertical-tab+carriage-return+line-feed+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\v\r\n\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+form-feed+carriage-return+line-feed+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\f\r\n\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+form-feed+carriage-return+tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\f\r\t\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+form-feed+line-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\f\n\r\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+form-feed+line-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\f\n\t\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+form-feed+tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\f\t\r\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+form-feed+tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\f\t\n\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+line-feed+form-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\n\f\r\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+line-feed+form-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\n\f\t\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+line-feed+carriage-return+form-feed+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\n\r\f\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+line-feed+carriage-return+tab+form-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\n\r\t\f16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+line-feed+tab+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\n\t\f\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+line-feed+tab+carriage-return+form-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\n\t\r\f16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+vertical-tab+form-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\v\f\r\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+vertical-tab+form-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\v\f\t\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+vertical-tab+carriage-return+form-feed+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\v\r\f\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+vertical-tab+carriage-return+tab+form-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\v\r\t\f16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+vertical-tab+tab+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\v\t\f\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+vertical-tab+tab+carriage-return+form-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\v\t\r\f16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+form-feed+carriage-return+tab+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\f\r\t\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+form-feed+carriage-return+vertical-tab+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\f\r\v\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+form-feed+tab+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\f\t\r\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+form-feed+tab+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\f\t\v\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+form-feed+vertical-tab+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\f\v\r\t16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+form-feed+vertical-tab+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\f\v\t\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign line-feed+tab+carriage-return+form-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\n\t\r\f\v16' || 'react/compiler-runtime'))`)
  ...
  - signed decimal numeric-string coercions with post-sign tab+form-feed+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+line-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\n\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+vertical-tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\v\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+vertical-tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\v\n\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\r\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\v\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\r\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+carriage-return+line-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\r\n\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+carriage-return+vertical-tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\r\v\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+line-feed+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\n\r\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+line-feed+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\n\v\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+tab+carriage-return+line-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\t\r\n\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+tab+carriage-return+vertical-tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\t\r\v\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+tab+line-feed+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\t\n\r\v16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+tab+line-feed+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\t\n\v\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+tab+vertical-tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\t\v\r\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign form-feed+tab+vertical-tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\f\t\v\n\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+tab+form-feed+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\t\f\n\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+tab+form-feed+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\t\f\r\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+tab+line-feed+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\t\n\f\r16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+tab+line-feed+carriage-return+form-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\t\n\r\f16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+tab+carriage-return+form-feed+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\t\r\f\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign vertical-tab+tab+carriage-return+line-feed+form-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\v\t\r\n\f16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+vertical-tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\v\r\n16' || 'react/compiler-runtime'))`)
  - signed decimal numeric-string coercions with post-sign tab+form-feed+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[(+1 && 'require')]((+'+\t\f\n\r16' || 'react/compiler-runtime'))`)
  ...
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\t\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\t\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\t\n\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+line-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\n\t\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+line-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\n\r\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\t\r\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+carriage-return+tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\r\t\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+vertical-tab+carriage-return+line-feed+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\v\r\n\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+form-feed+carriage-return+line-feed+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\f\r\n\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+form-feed+carriage-return+tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\f\r\t\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+form-feed+line-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\f\n\r\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+form-feed+line-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\f\n\t\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+form-feed+tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\f\t\r\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+form-feed+tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\f\t\n\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+line-feed+form-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\n\f\r\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+line-feed+form-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\n\f\t\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+line-feed+carriage-return+form-feed+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\n\r\f\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+line-feed+carriage-return+tab+form-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\n\r\t\f16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+line-feed+tab+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\n\t\f\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+line-feed+tab+carriage-return+form-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\n\t\r\f16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+vertical-tab+form-feed+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\v\f\r\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+vertical-tab+form-feed+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\v\f\t\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+vertical-tab+carriage-return+form-feed+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\v\r\f\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+vertical-tab+carriage-return+tab+form-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\v\r\t\f16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+vertical-tab+tab+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\v\t\f\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+vertical-tab+tab+carriage-return+form-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\v\t\r\f16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+form-feed+carriage-return+tab+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\f\r\t\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+form-feed+carriage-return+vertical-tab+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\f\r\v\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+form-feed+tab+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\f\t\r\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+form-feed+tab+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\f\t\v\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+form-feed+vertical-tab+carriage-return+tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\f\v\r\t16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+form-feed+vertical-tab+tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\f\v\t\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign line-feed+tab+carriage-return+form-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\n\t\r\f\v16'}\` || 'react/compiler-runtime')))` )
  ...
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+line-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\n\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+vertical-tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\v\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+vertical-tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\v\n\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\r\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\v\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\r\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+carriage-return+line-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\r\n\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+carriage-return+vertical-tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\r\v\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+line-feed+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\n\r\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+line-feed+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\n\v\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+tab+carriage-return+line-feed+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\t\r\n\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+tab+carriage-return+vertical-tab+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\t\r\v\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+tab+line-feed+carriage-return+vertical-tab whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\t\n\r\v16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+tab+line-feed+vertical-tab+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\t\n\v\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+tab+vertical-tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\t\v\r\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign form-feed+tab+vertical-tab+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\f\t\v\n\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+tab+form-feed+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\t\f\n\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+tab+form-feed+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\t\f\r\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+tab+line-feed+form-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\t\n\f\r16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+tab+line-feed+carriage-return+form-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\t\n\r\f16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+tab+carriage-return+form-feed+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\t\r\f\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign vertical-tab+tab+carriage-return+line-feed+form-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\v\t\r\n\f16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+vertical-tab+carriage-return+line-feed whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\v\r\n16'}\` || 'react/compiler-runtime')))` )
  - signed decimal template-string numeric coercions with post-sign tab+form-feed+line-feed+carriage-return whitespace also fold as `NaN`
    (e.g. `module[((+\`${'1'}\` && 'require'))](((+\`${'+\t\f\n\r16'}\` || 'react/compiler-runtime')))` )
